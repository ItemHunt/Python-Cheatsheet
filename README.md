...
- **``array_name[index_position]`` -** Returns a value from the specified index position. The first element is always index 0. Use positive numbers to go to the right or use negative numbers to go to the left.
...
- Tech with Tim Full Beginner Python Course (video) https://www.youtube.com/watch?v=sxTmJE4k0ho
